          ...
          <div className='flex flex-col lg:flex-row w-full items-center gap-3'>
            {
              inputsData[0].map((item, index) => {
                return (
                  <input type="text" className='w-full py-2 px-3 border bg-transparent text-ModeOne-text dark:text-ModeTwo-text border-ModeOne-text dark:border-ModeTwo-text rounded-md' placeholder={item.placeholder} />
                )
              })
            }
          </div>
